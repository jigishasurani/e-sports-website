        ...
        <div class="footer-2">
            <div class="main">
                ...
                <div class="col">
                    <h4>E-sport</h4>
                    <ul>
                        <li><a href="./game/bgmi.php">BGMI</a></li>
                        <li><a href="./game/valorant.php">VALORANT</a></li>
                        <li><a href="./game/pokemonunite.php">POKEMON UNITE</a></li>
                        <li><a href="./game/clashroyal.php">CLASH ROYAL</a></li>
                        <li><a href="./game/clashofclans.php">CLASH OF CLANS</a></li>
                    </ul>
                </div>
                <div class="col">
                    <h4>Information</h4>
